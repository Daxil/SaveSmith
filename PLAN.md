...
Статус: закрыты вехи 1, 2, 3, 4, 6, 7, 8 — ядро умеет найти сейв, разобрать, отредактировать и записать
с бэкапом, оценив риск. Интерфейса пока нет и он делается последним. Этот файл — рабочий
документ, обновляется по ходу.
...
| 9 | Выдача предметов в инвентарь: `containers` в манифесте, каталоги из файлов игры | план согласован |
