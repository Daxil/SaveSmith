...
**Окно** — если хочешь просто нажать кнопку. Скачиваешь `SaveSmith.dmg` (мак) или
`SaveSmith-setup.exe` (Windows), ставишь как любое другое приложение, открываешь.
Первым делом оно само найдёт установленные игры и покажет списком — выбираешь свою
и правишь. Печатать пути руками не нужно.
...
**[Последний релиз](../../releases/latest)** — там всё лежит готовым:
